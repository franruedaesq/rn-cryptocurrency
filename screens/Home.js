...
const Home = ({ navigation }) => {
      ...
      return(
          ...
          >
              ...
              >It's very difficult to time an investment,
                  especially if you're not familiar with the market.
                We recommend you to read the following articles before investing.
              </Text>
              <TouchableOpacity
                style={{
                    marginTop: SIZES.base
                }}
                onPress={() => console.log("Read more on pressed")}
              >
                  <Text
                    style={{
  ...
  function renderTransacationHistory() {
      return (
          <TransactionHistory 
